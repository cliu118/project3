...
class TextMapper():
    ...
    def map(self): 
            ...
            for line in lines:
                ...
                if text == "text":
                    continue
                friends = int(line[COLUMN_USER_FRIENDS])
                dt = line[COLUMN_DATE].split(' ', -1)[0]
                name = line[COLUMN_USER_NAME]

                # skip when friends too few or too many
                if friends < MIN_FRIEND or friends > MAX_FRIEND:
                    continue
                ...
                try:
                    ...
                    for word in words:
                        ...
                        for item in reg_item.groups():
                            ...
                            # output "word_date \t user name \t friends"
                            print(
                                self.sep.join([
                                    item.lower() + '_' + dt,
                                    name,
